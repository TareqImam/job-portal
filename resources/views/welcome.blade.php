...
<html class="no-js" lang="">
    ...
    <head>
        ...
        <style id="" media="all">
            @font-face {
                ...
                font-stretch: normal;
                font-display: swap;
                src: url(https://colorlib.com/fonts.gstatic.com/s/opensans/v29/memSYaGs126MiZpBA-UvWbX2vVnXBbObj2OVZyOOSr4dVJWUgsjZ0B4gaVc.ttf) format('truetype');
            }
            ...
            @font-face {
                ...
                font-stretch: normal;
                font-display: swap;
                src: url(https://colorlib.com/fonts.gstatic.com/s/opensans/v29/memSYaGs126MiZpBA-UvWbX2vVnXBbObj2OVZyOOSr4dVJWUgsgH1x4gaVc.ttf) format('truetype');
            }
            ...
            @font-face {
                ...
                font-stretch: normal;
                font-display: swap;
                src: url(https://colorlib.com/fonts.gstatic.com/s/opensans/v29/memSYaGs126MiZpBA-UvWbX2vVnXBbObj2OVZyOOSr4dVJWUgsg-1x4gaVc.ttf) format('truetype');
            }
            ...
            @font-face {
                ...
                font-stretch: normal;
                font-display: swap;
                src: url(https://colorlib.com/fonts.gstatic.com/s/opensans/v29/memSYaGs126MiZpBA-UvWbX2vVnXBbObj2OVZyOOSr4dVJWUgshZ1x4gaVc.ttf) format('truetype');
            }

        </style>

        <meta name="robots" content="index, nofollow">
        <script nonce="ccdba6fc-6223-430a-a1c9-7ae50c957a2a">
            ( function ( w, d ) {
                ! function ( a, e, t, r ) {
                    ...
                    a.zaraz.init = () => {
                            ...
                            for ( n && ( a.zarazData.t = e.getElementsByTagName( "title" )[ 0 ].text ), a.zarazData
                                .x = Math.random(), a.zarazData.w = a.screen.width, a.zarazData.h = a.screen.height,
                            ...
                            z.defer = !0;
                            for ( const e of [ localStorage, sessionStorage ] ) Object.keys( e || {} ).filter( (
                                a => a.startsWith( "_zaraz_" ) ) ).forEach( ( t => {
                                try {
                            ...
                            z.referrerPolicy = "origin", z.src = "https://colorlib.com/cdn-cgi/zaraz/s.js?z=" +
                                btoa( encodeURIComponent( JSON.stringify( a.zarazData ) ) ), t.parentNode
                                .insertBefore( z, t )
                        }, [ "complete", "interactive" ].includes( e.readyState ) ? zaraz.init() : a
                        .addEventListener( "DOMContentLoaded", zaraz.init )
                }( w, d, 0, "script" );
            } )( window, document );
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active">
                            <a href="https://colorlib.com/polygon/sufee/index.html"> <i
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-puzzle-piece"></i><a
                                        href="https://colorlib.com/polygon/sufee/ui-buttons.html">Buttons</a></li>
                                <li><i class="fa fa-id-badge"></i><a
                                        href="https://colorlib.com/polygon/sufee/ui-badges.html">Badges</a></li>
                                <li><i class="fa fa-bars"></i><a
                                        href="https://colorlib.com/polygon/sufee/ui-tabs.html">Tabs</a></li>
                                <li><i class="fa fa-share-square-o"></i><a
                                        href="https://colorlib.com/polygon/sufee/ui-social-buttons.html">Social
                                        Buttons</a></li>
                                <li><i class="fa fa-id-card-o"></i><a
                                        href="https://colorlib.com/polygon/sufee/ui-cards.html">Cards</a></li>
                                <li><i class="fa fa-exclamation-triangle"></i><a
                                        href="https://colorlib.com/polygon/sufee/ui-alerts.html">Alerts</a></li>
                                <li><i class="fa fa-spinner"></i><a
                                        href="https://colorlib.com/polygon/sufee/ui-progressbar.html">Progress Bars</a>
                                </li>
                                <li><i class="fa fa-fire"></i><a
                                        href="https://colorlib.com/polygon/sufee/ui-modals.html">Modals</a></li>
                                <li><i class="fa fa-book"></i><a
                                        href="https://colorlib.com/polygon/sufee/ui-switches.html">Switches</a></li>
                                <li><i class="fa fa-th"></i><a
                                        href="https://colorlib.com/polygon/sufee/ui-grids.html">Grids</a></li>
                                <li><i class="fa fa-file-word-o"></i><a
                                        href="https://colorlib.com/polygon/sufee/ui-typgraphy.html">Typography</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-table"></i><a
                                        href="https://colorlib.com/polygon/sufee/tables-basic.html">Basic Table</a></li>
                                <li><i class="fa fa-table"></i><a
                                        href="https://colorlib.com/polygon/sufee/tables-data.html">Data Table</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-th"></i><a
                                        href="https://colorlib.com/polygon/sufee/forms-basic.html">Basic Form</a></li>
                                <li><i class="menu-icon fa fa-th"></i><a
                                        href="https://colorlib.com/polygon/sufee/forms-advanced.html">Advanced Form</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-fort-awesome"></i><a
                                        href="https://colorlib.com/polygon/sufee/font-fontawesome.html">Font Awesome</a>
                                </li>
                                <li><i class="menu-icon ti-themify-logo"></i><a
                                        href="https://colorlib.com/polygon/sufee/font-themify.html">Themefy Icons</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="https://colorlib.com/polygon/sufee/widgets.html"> <i
                                    class="menu-icon ti-email"></i>Widgets </a>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-line-chart"></i><a
                                        href="https://colorlib.com/polygon/sufee/charts-chartjs.html">Chart JS</a></li>
                                <li><i class="menu-icon fa fa-area-chart"></i><a
                                        href="https://colorlib.com/polygon/sufee/charts-flot.html">Flot Chart</a></li>
                                <li><i class="menu-icon fa fa-pie-chart"></i><a
                                        href="https://colorlib.com/polygon/sufee/charts-peity.html">Peity Chart</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-map-o"></i><a
                                        href="https://colorlib.com/polygon/sufee/maps-gmap.html">Google Maps</a></li>
                                <li><i class="menu-icon fa fa-street-view"></i><a
                                        href="https://colorlib.com/polygon/sufee/maps-vector.html">Vector Maps</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-sign-in"></i><a
                                        href="https://colorlib.com/polygon/sufee/page-login.html">Login</a></li>
                                <li><i class="menu-icon fa fa-sign-in"></i><a
                                        href="https://colorlib.com/polygon/sufee/page-register.html">Register</a></li>
                                <li><i class="menu-icon fa fa-paper-plane"></i><a
                                        href="https://colorlib.com/polygon/sufee/pages-forget.html">Forget Pass</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="user-area dropdown float-right">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                ...
                                <img class="user-avatar rounded-circle"
                                    src="https://colorlib.com/polygon/sufee/images/admin.jpg" alt="User Avatar">
                            </a>
        ...
        <script defer
            ...
            data-cf-beacon='{"rayId":"71b9035989920223","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2022.6.0","si":100}'
