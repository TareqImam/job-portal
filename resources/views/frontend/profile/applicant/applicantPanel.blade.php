...
<head>
    ...
    <link href="{{url('frontend/profile/css/style.min.css')}}" rel="stylesheet" />
</head>
...
<body>
    ...
    <!----------------------------- All JS ------------------------------>
    <script src="{{url('frontend/profile/plugins/bower_components/jquery/dist/jquery.min.js')}}"></script>
    <script src="{{url('frontend/profile/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{url('frontend/profile/js/app-style-switcher.js')}}"></script>
    <script src="{{url('frontend/profile/js/waves.js')}}"></script>
    <script src="{{url('frontend/profile/js/sidebarmenu.js')}}"></script>
    <script src="{{url('frontend/profile/js/custom.js')}}"></script>
</body>
